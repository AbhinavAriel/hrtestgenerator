...
import { isAdminAuthenticated, saveAdminSession } from "../lib/adminAuth";
...
export default function AdminLogin() {
  ...
  const redirectTo = useMemo(() => location.state?.from?.pathname || "/admin", [location.state]);
        ...
        <div className="grid w-full overflow-hidden rounded-4xl border border-white/20 bg-white/15 shadow-2xl backdrop-blur-xl lg:grid-cols-[1.05fr_0.95fr] z-50">
          ...
          <div className="bg-white/92 p-6 sm:p-10">
            <div className="mx-auto flex h-full w-full max-w-md flex-col justify-center">
              <div className="mb-8">
                <p className="text-sm font-semibold uppercase tracking-[0.3em] text-blue-500">Admin Login</p>
                <h2 className="mt-3 text-3xl font-bold text-slate-900">Welcome Admin</h2>
